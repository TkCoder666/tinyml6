...
def inference():
    ...
    interpreter = MNN.Interpreter("/home/tk/code/tinyml6/mnn_inference/mobilenet_v1.mnn")
    session = interpreter.createSession()
    input_tensor = interpreter.getSessionInput(session)
    image = cv2.imread('/home/tk/code/tinyml6/mnn_inference/ILSVRC2012_val_00049999.JPEG')
